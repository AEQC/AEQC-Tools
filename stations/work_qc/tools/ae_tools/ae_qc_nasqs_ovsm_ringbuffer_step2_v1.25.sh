#!/bin/bash
#***************************** TITLE *********************************************************************
# Script Bash3.2  Recuperation RINBUFFER-NAQS                                                            *
# Version v1.25   13 mars 2013 AISSAOUI -IPGP  Paris                                                   *
#*********************************************************************************************************
# ATTENTION: Cette version de programme ne fonctionne qu'avec une archive miniseed de strucuture SDS     #
#*********************************************************************************************************
#************************* CONFIGURATIONS ****************************************************************
echo '***************************************************************************************************'
version_script=' Data Retrieve and correction from RINBUFFER-NAQS STEP2 script 13/3/13  AISSAOUI -IPGP Paris     '
...
echo '---------------------------------------------------------------------------------------------------'
echo '                               *** SYNTAXE ***                                                     '
echo ' ae_qc_nasqs_ringbuffer_step2_v1.25.sh [tasks_file][ip_station][dir_work_base][correction_buffer_base]'
echo ' [network] [station][canal][pid_parent] > ae_qc_nasqs_ringbuffer_step2_v1.25.log   '
echo '***************************************************************************************************'
echo ''
echo '***************************************************************************************************'
...
do 
 ...
 #***************************************************************************************
  ...
  then
   ...
   echo "AJOUT DE D'UN DELTA T DE 1 mn"
   ...
   echo "champ2 = "$champ2
   date2=$( date -d "$champ2  1 minute " +" %Y %m %d %H %M %S ")
   echo "date2 = "$date2
